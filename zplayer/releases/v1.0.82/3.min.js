        ...
        o.exports = function(o) {
                    ...
                    var l = function(o, r) {
                        ...
                        if (r && "function" == typeof btoa) {
                            ...
                            "/*# sourceMappingURL=data:application/json;charset=utf-8;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(c)))) + " */")
                              , n = t.sources.map(function(o) {
                                return "/*# sourceURL=" + t.sourceRoot + o + " */"
                            });
                            return [l].concat(n).concat([a]).join("\n")
                        }
                        var c;
                        return [l].join("\n")
                    }(r, o);
            ...
            r.i = function(o, l) {
                ...
                for (a = 0; a < o.length; a++) {
                    var c = o[a];
                    "number" == typeof c[0] && t[c[0]] || (l && !c[2] ? c[2] = l : l && (c[2] = "(" + c[2] + ") and (" + l + ")"),
                    r.push(c))
                }
            }
            ,
